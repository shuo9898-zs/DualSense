...
class CarlaSystem:
    ...
    def initialize(self):
        ...
        # Unreal rectangle: (16850,30900), (16850,30000), (18350,30900), (18350,30000) cm
        # CARLA: X=168.5~183.5 (m), Y=300.0~309.0 (m)
        self.driving_ui.add_work_zone(min_x=168.5, min_y=300.0, max_x=183.5, max_y=309.0)
    ...
    def _spawn_vehicle(self):
        ...
        target_location = carla.Location(x=-4.9, y=222.3)  # New position: Unreal (-490,22230) cm
