    ...
    def __init__(self, data_path: str, window_ms: int = 50):
        ...
        Args:
            data_path: 数据文件夹的完整路径
                      例如: C:\\Users\\BILAB\\Desktop\\CARLA_package\\py code\\35fps_Stable_Version\\data_collected\\carla_data_2025-10-17_23-03-08
...
if __name__ == "__main__":
    # ==================== 修改这里的路径 ====================
    data_path = r"C:\Users\BILAB\Desktop\CARLA_package\py code\35fps_Stable_Version\data_collected\carla_data_2025-10-18_15-59-00"
    # =====================================================
