...
class CarlaSystem:
    ...
    def initialize(self):
        ...
        # Unreal rectangle: (-4980,-2900), (-4110,-2900), (-4980,-1400), (-4110,-1400) cm
    ...
    def _spawn_vehicle(self):
        ...
        target_location = carla.Location(x=-195.0, y=-26.0)  # New position: Unreal (-19500,-2600) cm
        
        # Find the second-nearest spawn point instead of the nearest.
        sorted_spawns = sorted(spawn_points, key=lambda sp: sp.location.distance(target_location))
        closest_spawn = sorted_spawns[1] if len(sorted_spawns) > 1 else sorted_spawns[0]  # Use the second point.
