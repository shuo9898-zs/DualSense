...
class CarlaSystem:
    ...
    def initialize(self):
        ...
        # Unreal rectangle: (10460,-1510), (11170,-1515), (10460,-20), (11170,-20) cm
        # CARLA: X=104.6~111.7 (m), Y=-15.15~-0.2 (m)
        self.driving_ui.add_work_zone(min_x=104.6, min_y=-15.15, max_x=111.7, max_y=-0.2)
    ...
    def _spawn_vehicle(self):
        ...
        target_location = carla.Location(x=-1250.0, y=-6780.0)  # New position on the Town10HD map
